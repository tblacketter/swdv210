...
def removePlayer(players:list):
    while True:
        try:
            ...
            if userInput > 0 and userInput <= len(players):
                deletedPlayer = players.pop(userInput-1)
    ...
    while True:
        try:
            ...
            if userInput-1 > len(players) or userInput-1 < 0:
                ...
                print(f"{players[userInput-1].fullName()} was selected")
                ...
                if userInput-1 > len(players) or userInput-1 < 0:
                    ...
                    print(f"{players[userInput-1].fullName()} was moved")
                    break
        except:
    ...
    while True:
        try:
            ...
            if userInput-1 > len(players) or userInput-1 < 0:
                ...
                print(f"{players[userInput-1].fullName()} was selected current position is {players[userInput-1].position}")
                while True:
                    ...
                    if POSITIONS.count(position) == 0:
                        ...
                        players[userInput-1].changePosition(position)
                        print(f"{players[userInput-1].fullName()}'s position was changed")
                        break
                break
        except:
            print("Please enter a valid lineup number")
        ...
        while True:
            try:
                ...
                if userInput-1 > len(players) or userInput-1 < 0:
                    ...
                    print(f"You selected {players[userInput-1].fullName()}  AB={players[userInput-1].bats} H={players[userInput-1].hits}")
                    while True:
                        bats = getNumOfBats()
                        hits = getNumOfHits()
                        ...
                        if hits > bats:
                            ...
                            players[userInput-1].editPlayer(bats, hits)
                            print(f"{players[userInput-1].fullName()} was updated")
                            break
                    break
            except:
                print("Please enter a valid lineup number")
